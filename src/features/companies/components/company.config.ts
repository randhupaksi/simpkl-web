...
export const companyConfig: ResourceConfig<Company> = {
  ...
  fields: [
    ...
    { key: 'phone', label: 'Nomor telepon', inputMode: 'tel', maxLength: 14, sanitizer: 'phone', hint: 'Awali dengan 0 atau +62, misalnya 0217700000 atau +62217700000.', section: { title: 'C. Kontak dan lokasi', description: 'Saluran komunikasi serta alamat operasional perusahaan.' } },
    ...
    { key: 'postal_code', label: 'Kode pos', inputMode: 'numeric', maxLength: 5, sanitizer: 'digits', hint: 'Masukkan tepat 5 angka kode pos.', section: { title: 'C. Kontak dan lokasi', description: 'Saluran komunikasi serta alamat operasional perusahaan.' } },
    {
